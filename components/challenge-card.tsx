...
export function ChallengeCard() {
  ...
  return (
    <Card
      className="card-accent-top border-t-primary shadow-sm bg-[#FFF9D3] border-none rounded-lg overflow-hidden"
      id="challenge-card"
    >
      <CardHeader className="border-b border-border/40 pb-3">
        <div className="flex flex-wrap items-center gap-2">
          <h2 className="font-heading text-xl font-bold text-foreground">Today's Challenge:</h2>
